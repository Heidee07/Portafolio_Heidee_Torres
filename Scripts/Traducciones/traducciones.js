//___________________________________ JSON ___________________________________
...
const traducciones = {
    "es": {
        ...
        "subtitulo2_mis_habilidades": "Frontend & Diseño",
        "subtitulo3_mis_habilidades": "Herramientas",
        "ES_mis_habilidades": "Español (Nativo)",
        ...
        "institucion1_Acad_trayectoria": "UANL - FIME | <span class='text-white'>Promedio: 91</span>",
        "lista1_Acad_trayectoria": "<li>Egresada (Título en trámite).</li><li>Presentación de proyecto ante representante del CONAHCYT.</li><li>Participación en coloquios de proyectos de desarrollo.</li>",
        /*Networking*/
    ...
    "en": {
        ...
        "subtitulo1_mis_habilidades": "Backend & Data",
        "subtitulo2_mis_habilidades": "Frontend & Design",
        "subtitulo3_mis_habilidades": "Tools",
        "ES_mis_habilidades": "Spanish (Native)",
        "EN_mis_habilidades": "English (B1)",
        /*My Career*/
        "titulo_mi_trayectoria": "My <span style='color: #D22AA8;'>Career</span>",
        "subtitulo1_Prof_trayectoria": "Professional Experience",
        "etiqueta1_Prof_trayectoria": "Real Experience",
        "puesto1_Prof_trayectoria": "Full Stack Developer (Internship)",
        "lista1_Prof_trayectoria": "<li>Collaboration in the development of the corporate intranet at the company level.</li><li>Execution of QA tests to ensure system quality.</li><li>Led the automation of XML invoice reading (RayaXML Project).</li>",
        "subtitulo1_Acad_trayectoria": "Academic Background",
        "etiqueta1_Acad_trayectoria": "Higher Education",
        "grado1_Acad_trayectoria": "Software Technology Engineering",
        "institucion1_Acad_trayectoria": "UANL - FIME | <span class='text-white'>GPA: 91/100</span>",
        "lista1_Acad_trayectoria": "<li>Graduated (Degree issuance pending).</li><li>Presentation of project before CONAHCYT representative.</li><li>Participation in development project colloquiums.</li>",
        /*Networking*/
...
//___________________________________ Función para cambiar el idioma ___________________________________
function cambiarIdioma(idioma) {
    ...
    //Cookie para idioma
    document.cookie = "selectedLanguage=" + idioma + "; path=/";

    const elementos = document.querySelectorAll('[data-i18n]');

    elementos.forEach(elemento => {
        const llave = elemento.getAttribute('data-i18n');
        if (traducciones[idioma][llave]) {
            elemento.innerHTML = traducciones[idioma][llave];
        }
    });    
}
